...
if(action.type==='count/increase')return {...reduxState,count:reduxState.count+1};
else if(action.type==='count/decrease')return {...reduxState,count:reduxState.count-1};
else if(action.type==='count/decreaseBy')return {...reduxState,count:reduxState.count-action.payload};
else if(action.type==='count/increaseBy')return {...reduxState,count:reduxState.count+action.payload};
...
reduxState=reducer(reduxState,{type:'count/increase',payload:undefined});
console.log(reduxState);
reduxState=reducer(reduxState,{type:'count/decrease',payload:undefined});
console.log(reduxState);
reduxState=reducer(reduxState,{type:'count/increaseBy',payload:50});
console.log(reduxState);
}
