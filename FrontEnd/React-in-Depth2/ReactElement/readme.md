## 1 So for using react we have to import or push the react library code in our project . So tehere are two ways to push react into our project one is by using cdn links and other one by using npm.
